...
static struct proc_ops chardev_fops = {
    .proc_read = device_read,
    .proc_write = device_write,
    .proc_open = device_open,
    .proc_release = device_release
...
struct proc_ops Fops = {
        .proc_read = device_read,
        .proc_write = device_write,
        .proc_unlocked_ioctl = device_ioctl,
        .proc_open = device_open,
        .proc_release = device_release,      /* a.k.a. close */
};
...
struct proc_ops fops = {
    ...
    .proc_open = test_ioctl_open,
    .proc_release = test_ioctl_close,
    .proc_read = test_ioctl_read,
    .proc_unlocked_ioctl = test_ioctl_ioctl,
};
