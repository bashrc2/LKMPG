.. container::
   ...
   .. container::
      ...
      .. container::
         ...
         -  `1. Introduction <#orgdd254a3>`__

            -  `1.1. Authorship <#org9d4a361>`__
            -  `1.2. Versioning and Notes <#org980404d>`__
            -  `1.3. Acknowledgements <#org5664fdb>`__
            -  `1.4. What Is A Kernel Module? <#orge462377>`__
            -  `1.5. Kernel module package <#org3150a5d>`__
            -  `1.6. What Modules are in my Kernel? <#org42f7dae>`__
            -  `1.7. Do I need to download and compile the
               kernel? <#org1d3ded0>`__
            -  `1.8. Before We Begin <#org3b11690>`__

         -  `2. Headers <#orgc5a0d6c>`__
         -  `3. Examples <#orgd2781fb>`__
         -  `4. Hello World <#org1d116a3>`__

            -  `4.1. The Simplest Module <#org9253ed9>`__
            -  `4.2. Hello and Goodbye <#orgd5ee4b9>`__
            -  `4.3. The \__init and \__exit Macros <#orgb46336b>`__
            -  `4.4. Licensing and Module Documentation <#orga3e6021>`__
            -  `4.5. Passing Command Line Arguments to a
               Module <#org6cbe720>`__
            -  `4.6. Modules Spanning Multiple Files <#orgab0a988>`__
            -  `4.7. Building modules for a precompiled
               kernel <#orga65da8c>`__

         -  `5. Preliminaries <#orgd39d671>`__

            -  `5.1. How modules begin and end <#orgbfb945d>`__
            -  `5.2. Functions available to modules <#orgc74e1c5>`__
            -  `5.3. User Space vs Kernel Space <#org11212db>`__
            -  `5.4. Name Space <#org1da88d5>`__
            -  `5.5. Code space <#org032d77d>`__
            -  `5.6. Device Drivers <#org7801622>`__

         -  `6. Character Device drivers <#org9b484cd>`__

            -  `6.1. The proc_ops Structure <#org7f3a57e>`__
            -  `6.2. The file structure <#org068c562>`__
            -  `6.3. Registering A Device <#org8bdfc74>`__
            -  `6.4. Unregistering A Device <#org86cd4ec>`__
            -  `6.5. chardev.c <#org3dd4817>`__
            -  `6.6. Writing Modules for Multiple Kernel
               Versions <#org2f9f42c>`__

         -  `7. The /proc File System <#org4928937>`__

            -  `7.1. Read and Write a /proc File <#org8ae4f4f>`__
            -  `7.2. Manage /proc file with standard
               filesystem <#org57a767b>`__
            -  `7.3. Manage /proc file with seq_file <#org412e0de>`__

         -  `8. sysfs: Interacting with your module <#org074170c>`__
         -  `9. Talking To Device Files <#org9db11d2>`__
         -  `10. System Calls <#orgb9a97f0>`__
         -  `11. Blocking Processes and threads <#orgaedc5cf>`__

            -  `11.1. Sleep <#orgbd5591e>`__
            -  `11.2. Completions <#org998667d>`__

         -  `12. Avoiding Collisions and Deadlocks <#org98ba7c6>`__

            -  `12.1. Mutex <#org85420c7>`__
            -  `12.2. Spinlocks <#org2a7b84a>`__
            -  `12.3. Read and write locks <#orgc812a13>`__
            -  `12.4. Atomic operations <#org75430e5>`__

         -  `13. Replacing Print Macros <#orgf198c9b>`__

            -  `13.1. Replacement <#orgbae80cb>`__
            -  `13.2. Flashing keyboard LEDs <#org8db9458>`__

         -  `14. Scheduling Tasks <#orge734997>`__

            -  `14.1. Tasklets <#org785fd1c>`__
            -  `14.2. Work queues <#org27ac6f8>`__

         -  `15. Interrupt Handlers <#orgeca941e>`__

            -  `15.1. Interrupt Handlers <#org92bc1d9>`__
            -  `15.2. Detecting button presses <#orgf34936b>`__
            -  `15.3. Bottom Half <#org4646bc1>`__

         -  `16. Crypto <#orgef681dd>`__

            -  `16.1. Hash functions <#org46cf4c4>`__
            -  `16.2. Symmetric key encryption <#org1119c3f>`__

         -  `17. Standardising the interfaces: The Device
            Model <#orgaffe55c>`__
         -  `18. Optimisations <#org5436b5e>`__

            -  `18.1. Likely and Unlikely conditions <#orgadc3c35>`__

         -  `19. Common Pitfalls <#org33f73ba>`__

            -  `19.1. Using standard libraries <#orgc64e3b0>`__
            -  `19.2. Disabling interrupts <#orgdfbf5df>`__
            -  `19.3. Sticking your head inside a large
               carnivore <#orgee76e32>`__

         -  `20. Where To Go From Here? <#orgbbe942a>`__

   .. container:: outline-2
      :name: outline-container-orgdd254a3
      ...
      .. container:: outline-3
         :name: outline-container-org9d4a361
      ...
      .. container:: outline-3
         :name: outline-container-org980404d
      ...
      .. container:: outline-3
         :name: outline-container-org5664fdb
      ...
      .. container:: outline-3
         :name: outline-container-orge462377
      ...
      .. container:: outline-3
         :name: outline-container-org3150a5d
      ...
      .. container:: outline-3
         :name: outline-container-org42f7dae
      ...
      .. container:: outline-3
         :name: outline-container-org1d3ded0
      ...
      .. container:: outline-3
         :name: outline-container-org3b11690
   ...
   .. container:: outline-2
      :name: outline-container-orgc5a0d6c
   ...
   .. container:: outline-2
      :name: outline-container-orgd2781fb
   ...
   .. container:: outline-2
      :name: outline-container-org1d116a3
      ...
      .. container:: outline-3
         :name: outline-container-org9253ed9
      ...
      .. container:: outline-3
         :name: outline-container-orgd5ee4b9
      ...
      .. container:: outline-3
         :name: outline-container-orgb46336b
      ...
      .. container:: outline-3
         :name: outline-container-orga3e6021
      ...
      .. container:: outline-3
         :name: outline-container-org6cbe720
      ...
      .. container:: outline-3
         :name: outline-container-orgab0a988
      ...
      .. container:: outline-3
         :name: outline-container-orga65da8c
         ...
         .. container:: outline-text-3
            ...
            **/lib/modules/5.6.7-1.358/build**. A simple **cp
            ...
            UTS_RELEASE in file
            **/usr/src/linux-5.6.7/include/linux/version.h** according
            to contents of file
            **/lib/modules/5.6.7/build/include/linux/version.h**, or
   ...
   .. container:: outline-2
      :name: outline-container-orgd39d671
      ...
      .. container:: outline-3
         :name: outline-container-orgbfb945d
      ...
      .. container:: outline-3
         :name: outline-container-orgc74e1c5
      ...
      .. container:: outline-3
         :name: outline-container-org11212db
      ...
      .. container:: outline-3
         :name: outline-container-org1da88d5
      ...
      .. container:: outline-3
         :name: outline-container-org032d77d
      ...
      .. container:: outline-3
         :name: outline-container-org7801622
   ...
   .. container:: outline-2
      :name: outline-container-org9b484cd
      ...
      .. container:: outline-3
         :name: outline-container-org7f3a57e
      ...
      .. container:: outline-3
         :name: outline-container-org068c562
      ...
      .. container:: outline-3
         :name: outline-container-org8bdfc74
      ...
      .. container:: outline-3
         :name: outline-container-org86cd4ec
      ...
      .. container:: outline-3
         :name: outline-container-org3dd4817
      ...
      .. container:: outline-3
         :name: outline-container-org2f9f42c
   ...
   .. container:: outline-2
      :name: outline-container-org4928937
      ...
      .. container:: outline-3
         :name: outline-container-org8ae4f4f
      ...
      .. container:: outline-3
         :name: outline-container-org57a767b
      ...
      .. container:: outline-3
         :name: outline-container-org412e0de
   ...
   .. container:: outline-2
      :name: outline-container-org074170c
   ...
   .. container:: outline-2
      :name: outline-container-org9db11d2
   ...
   .. container:: outline-2
      :name: outline-container-orgb9a97f0
   ...
   .. container:: outline-2
      :name: outline-container-orgaedc5cf
      ...
      .. container:: outline-3
         :name: outline-container-orgbd5591e
      ...
      .. container:: outline-3
         :name: outline-container-org998667d
   ...
   .. container:: outline-2
      :name: outline-container-org98ba7c6
      ...
      .. container:: outline-3
         :name: outline-container-org85420c7
      ...
      .. container:: outline-3
         :name: outline-container-org2a7b84a
      ...
      .. container:: outline-3
         :name: outline-container-orgc812a13
      ...
      .. container:: outline-3
         :name: outline-container-org75430e5
   ...
   .. container:: outline-2
      :name: outline-container-orgf198c9b
      ...
      .. container:: outline-3
         :name: outline-container-orgbae80cb
      ...
      .. container:: outline-3
         :name: outline-container-org8db9458
   ...
   .. container:: outline-2
      :name: outline-container-orge734997
      ...
      .. container:: outline-3
         :name: outline-container-org785fd1c
      ...
      .. container:: outline-3
         :name: outline-container-org27ac6f8
   ...
   .. container:: outline-2
      :name: outline-container-orgeca941e
      ...
      .. container:: outline-3
         :name: outline-container-org92bc1d9
      ...
      .. container:: outline-3
         :name: outline-container-orgf34936b
      ...
      .. container:: outline-3
         :name: outline-container-org4646bc1
   ...
   .. container:: outline-2
      :name: outline-container-orgef681dd
      ...
      .. container:: outline-3
         :name: outline-container-org46cf4c4
      ...
      .. container:: outline-3
         :name: outline-container-org1119c3f
   ...
   .. container:: outline-2
      :name: outline-container-orgaffe55c
   ...
   .. container:: outline-2
      :name: outline-container-org5436b5e
      ...
      .. container:: outline-3
         :name: outline-container-orgadc3c35
   ...
   .. container:: outline-2
      :name: outline-container-org33f73ba
      ...
      .. container:: outline-3
         :name: outline-container-orgc64e3b0
      ...
      .. container:: outline-3
         :name: outline-container-orgdfbf5df
      ...
      .. container:: outline-3
         :name: outline-container-orgee76e32
   ...
   .. container:: outline-2
      :name: outline-container-orgbbe942a
