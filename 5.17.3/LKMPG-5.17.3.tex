...
\section{Hello World}
\label{sec:orga579006}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/walloffame.jpg}
\caption{\label{fig:org5d0ccd0}Wall of Fame. Katwijk, Netherlands.}
\end{figure}

\subsection{The Simplest Module}
\label{sec:org0a24773}
...
\label{sec:orga1b501a}

\subsection{How modules begin and end}
\label{sec:org0ba72db}
...
\label{sec:org198851b}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/kreuzberg.jpg}
\caption{\label{fig:orgb068d8b}Wall painting near Maybachufer in Berlin-Kreuzberg, Germany}
\end{figure}
...
\label{sec:orgfd1032e}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/luhansk.jpg}
\caption{\label{fig:org85579df}Lugansk, Ukraine}
\end{figure}
...
\caption{\label{fig:orge8f6af0}Street art in Ximen/Taipei, Taiwan}
\end{figure}

\section{System Calls}
\label{sec:orgdc84136}
...
\label{sec:org6ac7875}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/berlinwall.jpg}
\caption{\label{fig:orge52e689}Berlin Wall, 1989}
\end{figure}

\subsection{Sleep}
\label{sec:org8fe6e17}
...
\label{sec:orgd739e56}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/badass.jpg}
\caption{\label{fig:orga216151}Graffiti at a former roof felt factory in Santalahti, Tampere, Finland}
\end{figure}
...
\label{sec:org033a1b7}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/spin.jpg}
\caption{\label{fig:org0d718dd}Graffiti from Spin}
\end{figure}
...
\label{sec:orgcfb2b72}
\subsection{Replacement}
\label{sec:orga742b4b}
...
\label{sec:org72d9979}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/bucharest.jpg}
\caption{\label{fig:org68431bd}Graffiti artist in Bucharest, Romania}
\end{figure}

\subsection{Interrupt Handlers}
\label{sec:orge21c2a1}
