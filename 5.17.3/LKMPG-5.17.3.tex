...
\section{Hello World}
\label{sec:org1295ddb}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/walloffame.jpg}
\caption{\label{fig:org083f3f1}Wall of Fame. Katwijk, Netherlands.}
\end{figure}

\subsection{The Simplest Module}
\label{sec:org4f4ac8f}
...
\label{sec:org486dc80}

\subsection{How modules begin and end}
\label{sec:orgcb5ac42}
...
\label{sec:org0115b7f}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/kreuzberg.jpg}
\caption{\label{fig:org1dd1ecb}Wall painting near Maybachufer in Berlin-Kreuzberg, Germany}
\end{figure}
...
\label{sec:orgedfba93}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/luhansk.jpg}
\caption{\label{fig:orgc63512f}Lugansk, Ukraine}
\end{figure}
...
\caption{\label{fig:org030128a}Street art in Ximen/Taipei, Taiwan}
\end{figure}

\section{System Calls}
\label{sec:orgcb07641}
...
\label{sec:orgeaf23a1}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/berlinwall.jpg}
\caption{\label{fig:org2c65cc5}Berlin Wall, 1989}
\end{figure}

\subsection{Sleep}
\label{sec:org0db9233}
...
\caption{\label{fig:orgcb843c8}Graffiti at a former roof felt factory in Santalahti, Tampere, Finland}
\end{figure}
...
\label{sec:org75cdfef}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/spin.jpg}
\caption{\label{fig:orgd86c944}Graffiti from Spin}
\end{figure}
...
\label{sec:org5b33109}
\subsection{Replacement}
\label{sec:org02f808e}
...
\label{sec:orgc44d1d6}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/bucharest.jpg}
\caption{\label{fig:orgd497b99}Graffiti artist in Bucharest, Romania}
\end{figure}

\subsection{Interrupt Handlers}
\label{sec:orgede44a0}
