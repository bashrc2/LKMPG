...
\begin{center}
\includegraphics[width=.9\linewidth]{./img/cover.png}
\end{center}


\section{Introduction}
\label{sec:org47df00e}
...
\section{Hello World}
\label{sec:orgbe46d4a}
\subsection{The Simplest Module}
\label{sec:org8f11ea7}
...
\label{sec:orga45f3b2}
\subsection{How modules begin and end}
\label{sec:org98830a8}
...
\label{sec:org751afb8}
\subsection{The proc\_ops Structure}
\label{sec:org2a63cd8}
...
\label{sec:org6f5ecf8}
\subsection{Sleep}
\label{sec:orgad0e902}
...
\label{sec:org879fca1}
\subsection{Replacement}
\label{sec:org7d75d04}
...
\label{sec:orgd109186}
\subsection{Interrupt Handlers}
\label{sec:orgff0d255}
