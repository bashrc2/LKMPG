...
\section{Hello World}
\label{sec:org6e94855}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/walloffame.jpg}
\caption{\label{fig:org3af78e0}Wall of Fame. Katwijk, Netherlands.}
\end{figure}

\subsection{The Simplest Module}
\label{sec:org86ba1d3}
...
\label{sec:org0016951}

\subsection{How modules begin and end}
\label{sec:orgdcdc526}
...
\label{sec:org38671d5}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/kreuzberg.jpg}
\caption{\label{fig:orgacae888}Wall painting near Maybachufer in Berlin-Kreuzberg, Germany}
\end{figure}
...
\label{sec:org0bae3a9}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/luhansk.jpg}
\caption{\label{fig:orgf7ae922}Lugansk, Ukraine}
\end{figure}
...
\caption{\label{fig:org5009309}Street art in Ximen/Taipei, Taiwan}
\end{figure}

\section{System Calls}
\label{sec:orgc989d42}
...
\label{sec:orgb96304b}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/berlinwall.jpg}
\caption{\label{fig:org7d803e1}Berlin Wall, 1989}
\end{figure}

\subsection{Sleep}
\label{sec:org8b76cbb}
...
\label{sec:orge288782}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/badass.jpg}
\caption{\label{fig:orgb1f2174}Graffiti at a former roof felt factory in Santalahti, Tampere, Finland}
\end{figure}
...
\label{sec:org9e58191}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/spin.jpg}
\caption{\label{fig:orgff18c7e}Graffiti from Spin}
\end{figure}
...
\label{sec:orgdc73096}
\subsection{Replacement}
\label{sec:org7a4f6bd}
...
\label{sec:org4ba3653}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/bucharest.jpg}
\caption{\label{fig:orgf56569e}Graffiti artist in Bucharest, Romania}
\end{figure}

\subsection{Interrupt Handlers}
\label{sec:org40e75f2}
