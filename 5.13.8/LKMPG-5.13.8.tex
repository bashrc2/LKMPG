...
\section{Hello World}
\label{sec:orgd717eb4}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/walloffame.jpg}
\caption{\label{fig:org7e25ba3}Wall of Fame. Katwijk, Netherlands.}
\end{figure}

\subsection{The Simplest Module}
\label{sec:org4438fbe}
...
\label{sec:orga9a93d0}

\subsection{How modules begin and end}
\label{sec:orgfb5070a}
...
\label{sec:orgf270ef1}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/kreuzberg.jpg}
\caption{\label{fig:org2bab6ad}Wall painting near Maybachufer in Berlin-Kreuzberg, Germany}
\end{figure}
...
\label{sec:org67a3c79}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/luhansk.jpg}
\caption{\label{fig:org1037c2f}Lugansk, Ukraine}
\end{figure}
...
\caption{\label{fig:org54849d7}Street art in Ximen/Taipei, Taiwan}
\end{figure}

\section{System Calls}
\label{sec:org2e1e405}
...
\label{sec:orgb069a21}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/berlinwall.jpg}
\caption{\label{fig:org74a9ca4}Berlin Wall, 1989}
\end{figure}

\subsection{Sleep}
\label{sec:org2f1319b}
...
\label{sec:orgbe061df}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/badass.jpg}
\caption{\label{fig:org148a33d}Graffiti at a former roof felt factory in Santalahti, Tampere, Finland}
\end{figure}
...
\label{sec:orgc0f706d}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/spin.jpg}
\caption{\label{fig:org4c67217}Graffiti from Spin}
\end{figure}
...
\label{sec:orga11ebee}
\subsection{Replacement}
\label{sec:org1da7063}
...
\label{sec:org74c804f}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/bucharest.jpg}
\caption{\label{fig:orgf8baa4c}Graffiti artist in Bucharest, Romania}
\end{figure}

\subsection{Interrupt Handlers}
\label{sec:org8736877}
