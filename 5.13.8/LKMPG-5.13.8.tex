...
\section{Hello World}
\label{sec:orgd2a6161}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/walloffame.jpg}
\caption{\label{fig:org6f8ac05}Wall of Fame. Katwijk, Netherlands.}
\end{figure}

\subsection{The Simplest Module}
\label{sec:orgbb0d1d1}
...
\caption{\label{fig:orgc22be68}Stickers. Luisalvaz.}
\end{figure}

\subsection{Modules Spanning Multiple Files}
\label{sec:org3d2e95f}
...
\label{sec:orgb67fdcb}

\subsection{How modules begin and end}
\label{sec:org3a2d78f}
...
\label{sec:org55b1dae}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/kreuzberg.jpg}
\caption{\label{fig:org891f61a}Wall painting near Maybachufer in Berlin-Kreuzberg, Germany}
\end{figure}
...
\label{sec:orgf54d613}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/luhansk.jpg}
\caption{\label{fig:orgff98072}Lugansk, Ukraine}
\end{figure}
...
\label{sec:org808c77c}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/berlinwall.jpg}
\caption{\label{fig:org270ea7f}Berlin Wall, 1989}
\end{figure}

\subsection{Sleep}
\label{sec:orgc798723}
...
\label{sec:orgbff2dd4}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/badass.jpg}
\caption{\label{fig:org334fbd6}Graffiti at a former roof felt factory in Santalahti, Tampere, Finland}
\end{figure}
...
\label{sec:org9741dbf}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/spin.jpg}
\caption{\label{fig:org8631cad}Graffiti from Spin}
\end{figure}
...
\label{sec:org547e709}
\subsection{Replacement}
\label{sec:orgcf8a90d}
...
\label{sec:org63e59de}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/bucharest.jpg}
\caption{\label{fig:org2d43d2d}Graffiti artist in Bucharest, Romania}
\end{figure}

\subsection{Interrupt Handlers}
\label{sec:orga98bab8}
...
\caption{\label{fig:org88f2c68}Street art in Ximen/Taipei, Taiwan}
\end{figure}

\section{Where To Go From Here?}
\label{sec:orgb6ea649}
