...
\section{Hello World}
\label{sec:orgd5fd786}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/walloffame.jpg}
\caption{\label{fig:org44c9581}Wall of Fame. Katwijk, Netherlands.}
\end{figure}

\subsection{The Simplest Module}
\label{sec:org114e3e9}
...
\label{sec:org762b27e}

\subsection{How modules begin and end}
\label{sec:org411d74d}
...
\label{sec:org124802d}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/kreuzberg.jpg}
\caption{\label{fig:org37990aa}Wall painting near Maybachufer in Berlin-Kreuzberg, Germany}
\end{figure}
...
\label{sec:orgf0c2d61}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/luhansk.jpg}
\caption{\label{fig:orgd4e9cd1}Lugansk, Ukraine}
\end{figure}
...
\caption{\label{fig:orgee1c9be}Street art in Ximen/Taipei, Taiwan}
\end{figure}

\section{System Calls}
\label{sec:orge13277f}
...
\label{sec:orgd849534}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/berlinwall.jpg}
\caption{\label{fig:org2673906}Berlin Wall, 1989}
\end{figure}

\subsection{Sleep}
\label{sec:org5b97a87}
...
\label{sec:org4f2f4bb}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/badass.jpg}
\caption{\label{fig:org480b993}Graffiti at a former roof felt factory in Santalahti, Tampere, Finland}
\end{figure}
...
\label{sec:org7b1a3ae}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/spin.jpg}
\caption{\label{fig:orga3159b3}Graffiti from Spin}
\end{figure}
...
\label{sec:org35210fa}
\subsection{Replacement}
\label{sec:orgf72e663}
...
\label{sec:orga7b13d4}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/bucharest.jpg}
\caption{\label{fig:org8b9a59d}Graffiti artist in Bucharest, Romania}
\end{figure}

\subsection{Interrupt Handlers}
\label{sec:org6f0d036}
