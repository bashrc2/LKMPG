...
\section{Hello World}
\label{sec:org12fdaf3}
\subsection{The Simplest Module}
\label{sec:orgddae196}
...
\label{sec:org98cdb50}
\subsection{How modules begin and end}
\label{sec:orgb6fcf93}
...
\label{sec:org200664c}
\subsection{Sleep}
\label{sec:org8e5decb}
...
\label{sec:orgb191f8a}
\subsection{Replacement}
\label{sec:org5574528}
...
\label{sec:orged40e68}
\subsection{Interrupt Handlers}
\label{sec:org36bc38c}
