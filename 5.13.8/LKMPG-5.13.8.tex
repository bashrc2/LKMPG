...
\section{Hello World}
\label{sec:orga006c90}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/walloffame.jpg}
\caption{\label{fig:orga173478}Wall of Fame. Katwijk, Netherlands.}
\end{figure}

\subsection{The Simplest Module}
\label{sec:orgabb3ba6}
...
\label{sec:org3637456}

\subsection{How modules begin and end}
\label{sec:org1ba0aa4}
...
\label{sec:orgfa16ab4}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/kreuzberg.jpg}
\caption{\label{fig:orgc0f5f83}Wall painting near Maybachufer in Berlin-Kreuzberg, Germany}
\end{figure}
...
\label{sec:org61667d3}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/luhansk.jpg}
\caption{\label{fig:org878d8f6}Lugansk, Ukraine}
\end{figure}
...
\caption{\label{fig:org44de435}Street art in Ximen/Taipei, Taiwan}
\end{figure}

\section{System Calls}
\label{sec:org1e9e510}
...
\label{sec:org6a47e74}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/berlinwall.jpg}
\caption{\label{fig:org237bc1e}Berlin Wall, 1989}
\end{figure}

\subsection{Sleep}
\label{sec:orgd75525a}
...
\label{sec:org6fbe1b3}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/badass.jpg}
\caption{\label{fig:org66231ab}Graffiti at a former roof felt factory in Santalahti, Tampere, Finland}
\end{figure}
...
\label{sec:orgead7687}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/spin.jpg}
\caption{\label{fig:orgdbb6cd8}Graffiti from Spin}
\end{figure}
...
\label{sec:org568c5fc}
\subsection{Replacement}
\label{sec:org70f297a}
...
\label{sec:org873e59e}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/bucharest.jpg}
\caption{\label{fig:org98a71bf}Graffiti artist in Bucharest, Romania}
\end{figure}

\subsection{Interrupt Handlers}
\label{sec:org9dff227}
