...
\section{Hello World}
\label{sec:org0b01e8a}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/walloffame.jpg}
\caption{\label{fig:org8d2652a}Wall of Fame. Katwijk, Netherlands.}
\end{figure}

\subsection{The Simplest Module}
\label{sec:orge3072b2}
...
\caption{\label{fig:org948b912}Stickers. Luisalvaz.}
\end{figure}

\subsection{Modules Spanning Multiple Files}
\label{sec:orgcf0e482}
...
\label{sec:orgf417d7f}

\subsection{How modules begin and end}
\label{sec:orgdcf56c4}
...
\label{sec:org5bec353}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/kreuzberg.jpg}
\caption{\label{fig:org2413568}Wall painting near Maybachufer in Berlin-Kreuzberg, Germany}
\end{figure}
...
\label{sec:orgdd6597e}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/luhansk.jpg}
\caption{\label{fig:orgffa4b53}Lugansk, Ukraine}
\end{figure}
...
\label{sec:org2ea194c}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/berlinwall.jpg}
\caption{\label{fig:org082e2e7}Berlin Wall, 1989}
\end{figure}

\subsection{Sleep}
\label{sec:orgb08315d}
...
\label{sec:orgc50aad7}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/badass.jpg}
\caption{\label{fig:org6c7b927}Graffiti at a former roof felt factory in Santalahti, Tampere, Finland}
\end{figure}
...
\label{sec:orgf5094a8}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/spin.jpg}
\caption{\label{fig:org9a0bf56}Graffiti from Spin}
\end{figure}
...
\label{sec:org75938cc}
\subsection{Replacement}
\label{sec:orgbff7e42}
...
\label{sec:orgc43d0f3}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/bucharest.jpg}
\caption{\label{fig:org6cc9d6d}Graffiti artist in Bucharest, Romania}
\end{figure}

\subsection{Interrupt Handlers}
\label{sec:org927f7f1}
...
\caption{\label{fig:orgf28d07d}Street art in Ximen/Taipei, Taiwan}
\end{figure}

\section{Where To Go From Here?}
\label{sec:orgaf9612a}
