...
\section{Hello World}
\label{sec:org47e620f}
\subsection{The Simplest Module}
\label{sec:orgcf706aa}
...
\label{sec:orgc4e20ff}
\subsection{How modules begin and end}
\label{sec:org78e678e}
...
\label{sec:orgf8834bc}
\subsection{The proc\_ops Structure}
\label{sec:orge259b19}
...
\label{sec:orgf2b3a23}
\subsection{Sleep}
\label{sec:org2455e8d}
...
\label{sec:org2b16a4d}
\subsection{Replacement}
\label{sec:orgb4639cc}
...
\label{sec:org9510b03}
\subsection{Interrupt Handlers}
\label{sec:org9ad4d3d}
