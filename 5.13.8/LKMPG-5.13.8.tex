...
\section{Hello World}
\label{sec:orgeaad735}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/walloffame.jpg}
\caption{\label{fig:orgfc0c5ed}Wall of Fame. Katwijk, Netherlands.}
\end{figure}

\subsection{The Simplest Module}
\label{sec:org46956b2}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/stickers.jpg}
\caption{\label{fig:orge8084be}Stickers. Luisalvaz.}
\end{figure}

\subsection{Modules Spanning Multiple Files}
\label{sec:org037305e}
...
\label{sec:org4eafe27}

\subsection{How modules begin and end}
\label{sec:orgef14a15}
...
\label{sec:orgc2b5ab0}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/kreuzberg.jpg}
\caption{\label{fig:orgf341cb7}Wall painting near Maybachufer in Berlin-Kreuzberg, Germany}
\end{figure}
...
\label{sec:org305e566}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/luhansk.jpg}
\caption{\label{fig:org015f345}Lugansk, Ukraine}
\end{figure}
...
\label{sec:org6d71c1d}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/berlinwall.jpg}
\caption{\label{fig:org5f6d16d}Berlin Wall, 1989}
\end{figure}

\subsection{Sleep}
\label{sec:org7e5aab1}
...
\label{sec:orgdeb2d7e}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/badass.jpg}
\caption{\label{fig:org3fda129}Graffiti at a former roof felt factory in Santalahti, Tampere, Finland}
\end{figure}
...
\label{sec:org66ff316}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/spin.jpg}
\caption{\label{fig:orgbb2ae5d}Graffiti from Spin}
\end{figure}
...
\label{sec:orge8b7bb8}
\subsection{Replacement}
\label{sec:org9860dfc}
...
\label{sec:org60fda2b}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/bucharest.jpg}
\caption{\label{fig:orgd47d742}Graffiti artist in Bucharest, Romania}
\end{figure}

\subsection{Interrupt Handlers}
\label{sec:org42db27d}
...
\caption{\label{fig:orge9e0922}Street art in Ximen/Taipei, Taiwan}
\end{figure}

\section{Where To Go From Here?}
\label{sec:org556b188}
