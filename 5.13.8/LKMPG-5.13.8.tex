...
\section{Hello World}
\label{sec:org094d7ed}
\subsection{The Simplest Module}
\label{sec:orgf515517}
...
\label{sec:org340a448}
\subsection{How modules begin and end}
\label{sec:orgb2af473}
...
\label{sec:org2a4516e}
\subsection{Sleep}
\label{sec:orgd315ccf}
...
\label{sec:org9ee32db}
\subsection{Replacement}
\label{sec:orga02e56e}
...
\label{sec:org25ed65a}
\subsection{Interrupt Handlers}
\label{sec:orge60727e}
