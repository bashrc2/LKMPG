...
\section{Hello World}
\label{sec:org93ab2dc}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/walloffame.jpg}
\caption{\label{fig:org7594aa6}Wall of Fame. Katwijk, Netherlands.}
\end{figure}

\subsection{The Simplest Module}
\label{sec:org4b46461}
...
\label{sec:org8a7994e}

\subsection{How modules begin and end}
\label{sec:orgb438cc6}
...
\label{sec:org4be63b1}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/kreuzberg.jpg}
\caption{\label{fig:org8fb96b5}Wall painting near Maybachufer in Berlin-Kreuzberg, Germany}
\end{figure}
...
\label{sec:org999db1e}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/luhansk.jpg}
\caption{\label{fig:org47d2f6f}Lugansk, Ukraine}
\end{figure}
...
\caption{\label{fig:org6ca5bc7}Street art in Ximen/Taipei, Taiwan}
\end{figure}

\section{System Calls}
\label{sec:org8b4801c}
...
\label{sec:org8decb88}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/berlinwall.jpg}
\caption{\label{fig:org5c74567}Berlin Wall, 1989}
\end{figure}

\subsection{Sleep}
\label{sec:org0285aa6}
...
\label{sec:org80afaf0}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/badass.jpg}
\caption{\label{fig:orgb96782d}Graffiti at a former roof felt factory in Santalahti, Tampere, Finland}
\end{figure}
...
\label{sec:orgfbf4e23}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/spin.jpg}
\caption{\label{fig:org69515f8}Graffiti from Spin}
\end{figure}
...
\label{sec:org9be7d3e}
\subsection{Replacement}
\label{sec:orge7c5383}
...
\label{sec:org20802c7}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/bucharest.jpg}
\caption{\label{fig:org4c997fc}Graffiti artist in Bucharest, Romania}
\end{figure}

\subsection{Interrupt Handlers}
\label{sec:orgd7ac402}
