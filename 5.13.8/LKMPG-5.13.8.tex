...
\section{Hello World}
\label{sec:orgc359664}
\subsection{The Simplest Module}
\label{sec:org888e62e}
...
\label{sec:org666c630}
\subsection{How modules begin and end}
\label{sec:orgde41390}
...
\label{sec:org44bcebf}
\subsection{Sleep}
\label{sec:org34c579e}
...
\label{sec:orgd7825df}
\subsection{Replacement}
\label{sec:orgd1b10ab}
...
\label{sec:org892f3d6}
\subsection{Interrupt Handlers}
\label{sec:org02de87f}
