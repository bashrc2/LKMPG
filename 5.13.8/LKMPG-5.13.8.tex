...
\section{Hello World}
\label{sec:orgb0319d3}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/walloffame.jpg}
\caption{\label{fig:orgc1f4dd9}Wall of Fame. Katwijk, Netherlands.}
\end{figure}

\subsection{The Simplest Module}
\label{sec:org943f66a}
...
\caption{\label{fig:org6cabf3e}Stickers. Luisalvaz.}
\end{figure}

\subsection{Modules Spanning Multiple Files}
\label{sec:orge9be3fa}
...
\label{sec:orgf685893}

\subsection{How modules begin and end}
\label{sec:orgb959147}
...
\label{sec:org11062d9}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/kreuzberg.jpg}
\caption{\label{fig:orgc48446c}Wall painting near Maybachufer in Berlin-Kreuzberg, Germany}
\end{figure}
...
\label{sec:org4991009}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/luhansk.jpg}
\caption{\label{fig:orgc1f6aaf}Lugansk, Ukraine}
\end{figure}
...
\label{sec:org696e446}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/berlinwall.jpg}
\caption{\label{fig:orgd098433}Berlin Wall, 1989}
\end{figure}

\subsection{Sleep}
\label{sec:orge179aae}
...
\label{sec:org5b00a46}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/badass.jpg}
\caption{\label{fig:org7719e1f}Graffiti at a former roof felt factory in Santalahti, Tampere, Finland}
\end{figure}
...
\label{sec:org02b7cfd}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/spin.jpg}
\caption{\label{fig:org80e26e7}Graffiti from Spin}
\end{figure}
...
\label{sec:org2bd5452}
\subsection{Replacement}
\label{sec:orgdf57143}
...
\label{sec:org8d7a4f8}

\begin{figure}[htbp]
\centering
\includegraphics[width=100%]{./img/bucharest.jpg}
\caption{\label{fig:org48f401d}Graffiti artist in Bucharest, Romania}
\end{figure}

\subsection{Interrupt Handlers}
\label{sec:org3a15cec}
