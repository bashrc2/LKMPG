...
-   [1. Introduction](#orge8b0945)
    -   [1.1. Authorship](#orge9e7608)
    -   [1.2. Versioning and Notes](#orgeb43423)
    -   [1.3. Acknowledgements](#org01108ce)
    -   [1.4. What Is A Kernel Module?](#orgf2584de)
    -   [1.5. Installing some Dependencies](#org50ecdcc)
    -   [1.6. What Modules are in my Kernel?](#org6e66d93)
    -   [1.7. Do I need to download and compile the
        kernel?](#orga27ae86)
    -   [1.8. Before We Begin](#orgad8e819)
-   [2. Headers](#org7efe35f)
-   [3. Examples](#org3e172d0)
-   [4. Hello World](#orgd523e78)
    -   [4.1. The Simplest Module](#orgbbd99cd)
    -   [4.2. Hello and Goodbye](#orgc219bc2)
    -   [4.3. The \_\_init and \_\_exit Macros](#org10812eb)
    -   [4.4. Licensing and Module Documentation](#org017d5a6)
    -   [4.5. Passing Command Line Arguments to a Module](#org894b27c)
    -   [4.6. Modules Spanning Multiple Files](#orgc91ac03)
    -   [4.7. Building modules for a precompiled kernel](#org7f3daeb)
-   [5. Preliminaries](#org131a1a3)
    -   [5.1. How modules begin and end](#orgc403720)
    -   [5.2. Functions available to modules](#org11ff6c0)
    -   [5.3. User Space vs Kernel Space](#orgcc8d568)
    -   [5.4. Name Space](#orgd05bd90)
    -   [5.5. Code space](#orgeb4dad9)
    -   [5.6. Device Drivers](#orgd4d8a02)
-   [6. Character Device drivers](#orgd527647)
    -   [6.1. The file\_operations Structure](#org5636d2e)
    -   [6.2. The file structure](#orga1bb5c1)
    -   [6.3. Registering A Device](#org698dbc9)
    -   [6.4. Unregistering A Device](#org2c54478)
    -   [6.5. chardev.c](#org84aab17)
    -   [6.6. Writing Modules for Multiple Kernel Versions](#org24d0b35)
-   [7. The /proc File System](#org96f6cdd)
    -   [7.1. Read and Write a /proc File](#org28b8d15)
    -   [7.2. Manage /proc file with standard filesystem](#org7b76ceb)
    -   [7.3. Manage /proc file with seq\_file](#org77c58b5)
-   [8. sysfs: Interacting with your module](#orgc90eaeb)
-   [9. Talking To Device Files](#org9a292bf)
-   [10. System Calls](#org00ab4f0)
-   [11. Blocking Processes and threads](#org649e878)
    -   [11.1. Sleep](#org3930561)
    -   [11.2. Completions](#org2e3a98a)
-   [12. Avoiding Collisions and Deadlocks](#org666e449)
    -   [12.1. Mutex](#orgaba085f)
    -   [12.2. Spinlocks](#org18ab81f)
    -   [12.3. Read and write locks](#org6d10dcb)
    -   [12.4. Atomic operations](#org75e233d)
-   [13. Replacing Print Macros](#org5c32adc)
    -   [13.1. Replacement](#org87e4912)
    -   [13.2. Flashing keyboard LEDs](#orgb569cd2)
-   [14. Scheduling Tasks](#orgbe3f0e2)
    -   [14.1. Tasklets](#orged8693c)
    -   [14.2. Work queues](#org1037547)
-   [15. Interrupt Handlers](#org93a1e5c)
    -   [15.1. Interrupt Handlers](#org62da0e8)
    -   [15.2. Detecting button presses](#org5149184)
    -   [15.3. Bottom Half](#org5c8c739)
-   [16. Crypto](#orge4c8577)
    -   [16.1. Hash functions](#orgd499670)
    -   [16.2. Symmetric key encryption](#org6037d21)
-   [17. Standardising the interfaces: The Device Model](#orgc2a676e)
-   [18. Optimisations](#org2e7c0d9)
    -   [18.1. Likely and Unlikely conditions](#org5be6697)
-   [19. Common Pitfalls](#org71556e4)
    -   [19.1. Using standard libraries](#orga90dd21)
    -   [19.2. Disabling interrupts](#org7ef9c62)
    -   [19.3. Sticking your head inside a large carnivore](#orgebda34f)
-   [20. Where To Go From Here?](#org2644423)
:::
:::

\[\[\#+TITLE: The Linux Kernel Module Programming Guide

::: {#outline-container-orge8b0945 .outline-2}
[1.]{.section-number-2} Introduction {#orge8b0945}
------------------------------------
...
::: {#outline-container-orge9e7608 .outline-3}
### [1.1.]{.section-number-3} Authorship {#orge9e7608}
...
::: {#outline-container-orgeb43423 .outline-3}
### [1.2.]{.section-number-3} Versioning and Notes {#orgeb43423}
...
::: {#outline-container-org01108ce .outline-3}
### [1.3.]{.section-number-3} Acknowledgements {#org01108ce}
...
::: {#outline-container-orgf2584de .outline-3}
### [1.4.]{.section-number-3} What Is A Kernel Module? {#orgf2584de}
...
::: {#outline-container-org50ecdcc .outline-3}
### [1.5.]{.section-number-3} Installing some Dependencies {#org50ecdcc}
...
::: {#outline-container-org6e66d93 .outline-3}
### [1.6.]{.section-number-3} What Modules are in my Kernel? {#org6e66d93}
...
::: {#outline-container-orga27ae86 .outline-3}
### [1.7.]{.section-number-3} Do I need to download and compile the kernel? {#orga27ae86}
...
::: {#outline-container-orgad8e819 .outline-3}
### [1.8.]{.section-number-3} Before We Begin {#orgad8e819}
...
::: {#outline-container-org7efe35f .outline-2}
[2.]{.section-number-2} Headers {#org7efe35f}
-------------------------------
...
::: {#outline-container-org3e172d0 .outline-2}
[3.]{.section-number-2} Examples {#org3e172d0}
--------------------------------
...
::: {#outline-container-orgd523e78 .outline-2}
[4.]{.section-number-2} Hello World {#orgd523e78}
-----------------------------------

::: {#text-4 .outline-text-2}
:::

::: {#outline-container-orgbbd99cd .outline-3}
### [4.1.]{.section-number-3} The Simplest Module {#orgbbd99cd}
...
1.  []{#org5b73c50}A point about coding style\
    ...
    :::
2.  []{#org8bc0ab6}Introducing print macros\
...
::: {#outline-container-orgc219bc2 .outline-3}
### [4.2.]{.section-number-3} Hello and Goodbye {#orgc219bc2}
...
::: {#outline-container-org10812eb .outline-3}
### [4.3.]{.section-number-3} The \_\_init and \_\_exit Macros {#org10812eb}
...
::: {#outline-container-org017d5a6 .outline-3}
### [4.4.]{.section-number-3} Licensing and Module Documentation {#org017d5a6}
...
::: {#outline-container-org894b27c .outline-3}
### [4.5.]{.section-number-3} Passing Command Line Arguments to a Module {#org894b27c}
...
::: {#outline-container-orgc91ac03 .outline-3}
### [4.6.]{.section-number-3} Modules Spanning Multiple Files {#orgc91ac03}
...
::: {#outline-container-org7f3daeb .outline-3}
### [4.7.]{.section-number-3} Building modules for a precompiled kernel {#org7f3daeb}
...
::: {#outline-container-org131a1a3 .outline-2}
[5.]{.section-number-2} Preliminaries {#org131a1a3}
-------------------------------------

::: {#text-5 .outline-text-2}
:::

::: {#outline-container-orgc403720 .outline-3}
### [5.1.]{.section-number-3} How modules begin and end {#orgc403720}
...
::: {#outline-container-org11ff6c0 .outline-3}
### [5.2.]{.section-number-3} Functions available to modules {#org11ff6c0}
...
::: {#outline-container-orgcc8d568 .outline-3}
### [5.3.]{.section-number-3} User Space vs Kernel Space {#orgcc8d568}
...
::: {#outline-container-orgd05bd90 .outline-3}
### [5.4.]{.section-number-3} Name Space {#orgd05bd90}
...
::: {#outline-container-orgeb4dad9 .outline-3}
### [5.5.]{.section-number-3} Code space {#orgeb4dad9}
...
::: {#outline-container-orgd4d8a02 .outline-3}
### [5.6.]{.section-number-3} Device Drivers {#orgd4d8a02}
...
1.  []{#org761e52a}Major and Minor Numbers\
...
::: {#outline-container-orgd527647 .outline-2}
[6.]{.section-number-2} Character Device drivers {#orgd527647}
------------------------------------------------

::: {#text-6 .outline-text-2}
:::

::: {#outline-container-org5636d2e .outline-3}
### [6.1.]{.section-number-3} The file\_operations Structure {#org5636d2e}
...
::: {#outline-container-orga1bb5c1 .outline-3}
### [6.2.]{.section-number-3} The file structure {#orga1bb5c1}
...
::: {#outline-container-org698dbc9 .outline-3}
### [6.3.]{.section-number-3} Registering A Device {#org698dbc9}
...
::: {#outline-container-org2c54478 .outline-3}
### [6.4.]{.section-number-3} Unregistering A Device {#org2c54478}
...
::: {#outline-container-org84aab17 .outline-3}
### [6.5.]{.section-number-3} chardev.c {#org84aab17}
...
::: {#outline-container-org24d0b35 .outline-3}
### [6.6.]{.section-number-3} Writing Modules for Multiple Kernel Versions {#org24d0b35}
...
::: {#outline-container-org96f6cdd .outline-2}
[7.]{.section-number-2} The /proc File System {#org96f6cdd}
---------------------------------------------
...
::: {#outline-container-org28b8d15 .outline-3}
### [7.1.]{.section-number-3} Read and Write a /proc File {#org28b8d15}
...
::: {#outline-container-org7b76ceb .outline-3}
### [7.2.]{.section-number-3} Manage /proc file with standard filesystem {#org7b76ceb}
...
::: {#outline-container-org77c58b5 .outline-3}
### [7.3.]{.section-number-3} Manage /proc file with seq\_file {#org77c58b5}
...
::: {#outline-container-orgc90eaeb .outline-2}
[8.]{.section-number-2} sysfs: Interacting with your module {#orgc90eaeb}
-----------------------------------------------------------
...
::: {#outline-container-org9a292bf .outline-2}
[9.]{.section-number-2} Talking To Device Files {#org9a292bf}
-----------------------------------------------
...
::: {#outline-container-org00ab4f0 .outline-2}
[10.]{.section-number-2} System Calls {#org00ab4f0}
-------------------------------------
...
::: {#outline-container-org649e878 .outline-2}
[11.]{.section-number-2} Blocking Processes and threads {#org649e878}
-------------------------------------------------------

::: {#text-11 .outline-text-2}
:::

::: {#outline-container-org3930561 .outline-3}
### [11.1.]{.section-number-3} Sleep {#org3930561}
...
::: {#outline-container-org2e3a98a .outline-3}
### [11.2.]{.section-number-3} Completions {#org2e3a98a}
...
::: {#outline-container-org666e449 .outline-2}
[12.]{.section-number-2} Avoiding Collisions and Deadlocks {#org666e449}
----------------------------------------------------------
...
::: {#outline-container-orgaba085f .outline-3}
### [12.1.]{.section-number-3} Mutex {#orgaba085f}
...
::: {#outline-container-org18ab81f .outline-3}
### [12.2.]{.section-number-3} Spinlocks {#org18ab81f}
...
::: {#outline-container-org6d10dcb .outline-3}
### [12.3.]{.section-number-3} Read and write locks {#org6d10dcb}
...
::: {#outline-container-org75e233d .outline-3}
### [12.4.]{.section-number-3} Atomic operations {#org75e233d}
...
::: {#outline-container-org5c32adc .outline-2}
[13.]{.section-number-2} Replacing Print Macros {#org5c32adc}
-----------------------------------------------

::: {#text-13 .outline-text-2}
:::

::: {#outline-container-org87e4912 .outline-3}
### [13.1.]{.section-number-3} Replacement {#org87e4912}
...
::: {#outline-container-orgb569cd2 .outline-3}
### [13.2.]{.section-number-3} Flashing keyboard LEDs {#orgb569cd2}
...
::: {#outline-container-orgbe3f0e2 .outline-2}
[14.]{.section-number-2} Scheduling Tasks {#orgbe3f0e2}
-----------------------------------------
...
::: {#outline-container-orged8693c .outline-3}
### [14.1.]{.section-number-3} Tasklets {#orged8693c}
...
::: {#outline-container-org1037547 .outline-3}
### [14.2.]{.section-number-3} Work queues {#org1037547}
...
::: {#outline-container-org93a1e5c .outline-2}
[15.]{.section-number-2} Interrupt Handlers {#org93a1e5c}
-------------------------------------------

::: {#text-15 .outline-text-2}
:::

::: {#outline-container-org62da0e8 .outline-3}
### [15.1.]{.section-number-3} Interrupt Handlers {#org62da0e8}
...
::: {#outline-container-org5149184 .outline-3}
### [15.2.]{.section-number-3} Detecting button presses {#org5149184}
...
::: {#outline-container-org5c8c739 .outline-3}
### [15.3.]{.section-number-3} Bottom Half {#org5c8c739}
...
::: {#outline-container-orge4c8577 .outline-2}
[16.]{.section-number-2} Crypto {#orge4c8577}
-------------------------------
...
::: {#outline-container-orgd499670 .outline-3}
### [16.1.]{.section-number-3} Hash functions {#orgd499670}
...
::: {#outline-container-org6037d21 .outline-3}
### [16.2.]{.section-number-3} Symmetric key encryption {#org6037d21}
...
::: {#outline-container-orgc2a676e .outline-2}
[17.]{.section-number-2} Standardising the interfaces: The Device Model {#orgc2a676e}
-----------------------------------------------------------------------
...
::: {#outline-container-org2e7c0d9 .outline-2}
[18.]{.section-number-2} Optimisations {#org2e7c0d9}
--------------------------------------

::: {#text-18 .outline-text-2}
:::

::: {#outline-container-org5be6697 .outline-3}
### [18.1.]{.section-number-3} Likely and Unlikely conditions {#org5be6697}
...
::: {#outline-container-org71556e4 .outline-2}
[19.]{.section-number-2} Common Pitfalls {#org71556e4}
----------------------------------------
...
::: {#outline-container-orga90dd21 .outline-3}
### [19.1.]{.section-number-3} Using standard libraries {#orga90dd21}
...
::: {#outline-container-org7ef9c62 .outline-3}
### [19.2.]{.section-number-3} Disabling interrupts {#org7ef9c62}
...
::: {#outline-container-orgebda34f .outline-3}
### [19.3.]{.section-number-3} Sticking your head inside a large carnivore {#orgebda34f}
...
::: {#outline-container-org2644423 .outline-2}
[20.]{.section-number-2} Where To Go From Here? {#org2644423}
-----------------------------------------------
