...
-   [1. Introduction](#orgebfe063)
    -   [1.1. Authorship](#orgb61c3e3)
    -   [1.2. Versioning and Notes](#org385d091)
    -   [1.3. Acknowledgements](#org6011450)
    -   [1.4. What Is A Kernel Module?](#orgbc6fd45)
    -   [1.5. Kernel module package](#org4541c0e)
    -   [1.6. What Modules are in my Kernel?](#org9d34ca4)
    -   [1.7. Do I need to download and compile the
        kernel?](#orga633778)
    -   [1.8. Before We Begin](#org86d047d)
-   [2. Headers](#org8774d36)
-   [3. Examples](#org178280d)
-   [4. Hello World](#orgd516d3e)
    -   [4.1. The Simplest Module](#orgf5575c3)
    -   [4.2. Hello and Goodbye](#org80b6e80)
    -   [4.3. The \_\_init and \_\_exit Macros](#org63e643c)
    -   [4.4. Licensing and Module Documentation](#org5f35806)
    -   [4.5. Passing Command Line Arguments to a Module](#orgb09c36b)
    -   [4.6. Modules Spanning Multiple Files](#orgf24e2d6)
    -   [4.7. Building modules for a precompiled kernel](#org6547d97)
-   [5. Preliminaries](#org69c4bac)
    -   [5.1. How modules begin and end](#org14d4246)
    -   [5.2. Functions available to modules](#org3d568fe)
    -   [5.3. User Space vs Kernel Space](#org82ffd6f)
    -   [5.4. Name Space](#org57bd55a)
...
-   [6. Character Device drivers](#org75a6a42)
    ...
    -   [6.5. chardev.c](#orga127c69)
    -   [6.6. Writing Modules for Multiple Kernel Versions](#org5f4fba7)
...
-   [11. Blocking Processes and threads](#orga2fd0c2)
    -   [11.1. Sleep](#org4ae37a4)
    -   [11.2. Completions](#orge39fd84)
-   [12. Avoiding Collisions and Deadlocks](#org78193ce)
    -   [12.1. Mutex](#orge1ae933)
    -   [12.2. Spinlocks](#orgd3b6dbb)
    -   [12.3. Read and write locks](#orgda5e757)
    -   [12.4. Atomic operations](#org5266b19)
-   [13. Replacing Print Macros](#org0241a39)
    -   [13.1. Replacement](#org45d7d00)
    -   [13.2. Flashing keyboard LEDs](#orgf7faf48)
-   [14. Scheduling Tasks](#org9a71054)
    -   [14.1. Tasklets](#orgb6837ac)
    -   [14.2. Work queues](#org079ad3d)
-   [15. Interrupt Handlers](#org47d5026)
    -   [15.1. Interrupt Handlers](#orgd8a30b0)
    -   [15.2. Detecting button presses](#org9691762)
    -   [15.3. Bottom Half](#org3ba808d)
-   [16. Crypto](#org01272be)
    -   [16.1. Hash functions](#orgbc96d6e)
    -   [16.2. Symmetric key encryption](#orgaa2193a)
-   [17. Standardising the interfaces: The Device Model](#org75d267e)
-   [18. Optimisations](#org391b9a6)
    -   [18.1. Likely and Unlikely conditions](#org54ba33e)
-   [19. Common Pitfalls](#org109e4b3)
    -   [19.1. Using standard libraries](#org9005cc0)
    -   [19.2. Disabling interrupts](#orgf1b91de)
    -   [19.3. Sticking your head inside a large carnivore](#orgf06728b)
-   [20. Where To Go From Here?](#org4e6c171)
:::
:::
...
::: {#outline-container-orgb61c3e3 .outline-3}
### [1.1]{.section-number-3} Authorship {#orgb61c3e3}
...
::: {#outline-container-org385d091 .outline-3}
### [1.2]{.section-number-3} Versioning and Notes {#org385d091}
...
::: {#outline-container-org6011450 .outline-3}
### [1.3]{.section-number-3} Acknowledgements {#org6011450}
...
::: {#outline-container-orgbc6fd45 .outline-3}
### [1.4]{.section-number-3} What Is A Kernel Module? {#orgbc6fd45}
...
::: {#outline-container-org4541c0e .outline-3}
### [1.5]{.section-number-3} Kernel module package {#org4541c0e}
...
::: {#outline-container-org9d34ca4 .outline-3}
### [1.6]{.section-number-3} What Modules are in my Kernel? {#org9d34ca4}
...
::: {#outline-container-orga633778 .outline-3}
### [1.7]{.section-number-3} Do I need to download and compile the kernel? {#orga633778}
...
::: {#outline-container-org86d047d .outline-3}
### [1.8]{.section-number-3} Before We Begin {#org86d047d}
...
::: {#outline-container-orgf5575c3 .outline-3}
### [4.1]{.section-number-3} The Simplest Module {#orgf5575c3}
...
::: {#outline-container-org80b6e80 .outline-3}
...
::: {#outline-container-org63e643c .outline-3}
### [4.3]{.section-number-3} The \_\_init and \_\_exit Macros {#org63e643c}
...
::: {#outline-container-org5f35806 .outline-3}
### [4.4]{.section-number-3} Licensing and Module Documentation {#org5f35806}
...
::: {#outline-container-orgb09c36b .outline-3}
### [4.5]{.section-number-3} Passing Command Line Arguments to a Module {#orgb09c36b}
...
::: {#outline-container-orgf24e2d6 .outline-3}
### [4.6]{.section-number-3} Modules Spanning Multiple Files {#orgf24e2d6}
...
::: {#outline-container-org6547d97 .outline-3}
### [4.7]{.section-number-3} Building modules for a precompiled kernel {#org6547d97}
...
::: {#outline-container-org14d4246 .outline-3}
### [5.1]{.section-number-3} How modules begin and end {#org14d4246}
...
::: {#outline-container-org3d568fe .outline-3}
### [5.2]{.section-number-3} Functions available to modules {#org3d568fe}
...
::: {#outline-container-org82ffd6f .outline-3}
### [5.3]{.section-number-3} User Space vs Kernel Space {#org82ffd6f}
...
::: {#outline-container-org57bd55a .outline-3}
### [5.4]{.section-number-3} Name Space {#org57bd55a}
...
::: {#outline-container-orgb7b2579 .outline-3}
### [5.5]{.section-number-3} Code space {#orgb7b2579}
...
::: {#outline-container-org4aa5435 .outline-3}
### [5.6]{.section-number-3} Device Drivers {#org4aa5435}
...
::: {#outline-container-orgc00f983 .outline-3}
### [6.2]{.section-number-3} The file structure {#orgc00f983}
...
::: {#outline-container-org4c12be8 .outline-3}
### [6.3]{.section-number-3} Registering A Device {#org4c12be8}
...
::: {#outline-container-org02630db .outline-3}
### [6.4]{.section-number-3} Unregistering A Device {#org02630db}
...
::: {#outline-container-orga127c69 .outline-3}
### [6.5]{.section-number-3} chardev.c {#orga127c69}
...
::: {#outline-container-org5f4fba7 .outline-3}
### [6.6]{.section-number-3} Writing Modules for Multiple Kernel Versions {#org5f4fba7}
...
::: {#outline-container-org1ec3ec9 .outline-3}
### [7.1]{.section-number-3} Read and Write a /proc File {#org1ec3ec9}
...
::: {#outline-container-org2eadda1 .outline-3}
### [7.2]{.section-number-3} Manage /proc file with standard filesystem {#org2eadda1}
...
::: {#outline-container-org4ae37a4 .outline-3}
### [11.1]{.section-number-3} Sleep {#org4ae37a4}
...
::: {#outline-container-orge39fd84 .outline-3}
### [11.2]{.section-number-3} Completions {#orge39fd84}
...
::: {#outline-container-orge1ae933 .outline-3}
### [12.1]{.section-number-3} Mutex {#orge1ae933}
...
::: {#outline-container-orgd3b6dbb .outline-3}
### [12.2]{.section-number-3} Spinlocks {#orgd3b6dbb}
...
::: {#outline-container-orgda5e757 .outline-3}
### [12.3]{.section-number-3} Read and write locks {#orgda5e757}
...
::: {#outline-container-org5266b19 .outline-3}
### [12.4]{.section-number-3} Atomic operations {#org5266b19}
...
::: {#outline-container-org45d7d00 .outline-3}
### [13.1]{.section-number-3} Replacement {#org45d7d00}
...
::: {#outline-container-orgf7faf48 .outline-3}
### [13.2]{.section-number-3} Flashing keyboard LEDs {#orgf7faf48}
...
::: {#outline-container-orgb6837ac .outline-3}
...
::: {#outline-container-org079ad3d .outline-3}
### [14.2]{.section-number-3} Work queues {#org079ad3d}
...
::: {#outline-container-orgd8a30b0 .outline-3}
### [15.1]{.section-number-3} Interrupt Handlers {#orgd8a30b0}
...
::: {#outline-container-org9691762 .outline-3}
### [15.2]{.section-number-3} Detecting button presses {#org9691762}
...
::: {#outline-container-org3ba808d .outline-3}
### [15.3]{.section-number-3} Bottom Half {#org3ba808d}
...
::: {#outline-container-orgbc96d6e .outline-3}
### [16.1]{.section-number-3} Hash functions {#orgbc96d6e}
...
::: {#outline-container-orgaa2193a .outline-3}
### [16.2]{.section-number-3} Symmetric key encryption {#orgaa2193a}
...
::: {#outline-container-org54ba33e .outline-3}
### [18.1]{.section-number-3} Likely and Unlikely conditions {#org54ba33e}
...
::: {#outline-container-org9005cc0 .outline-3}
### [19.1]{.section-number-3} Using standard libraries {#org9005cc0}
...
::: {#outline-container-orgf1b91de .outline-3}
### [19.2]{.section-number-3} Disabling interrupts {#orgf1b91de}
...
::: {#outline-container-orgf06728b .outline-3}
### [19.3]{.section-number-3} Sticking your head inside a large carnivore {#orgf06728b}
